document.addEventListener("DOMContentLoaded", function () {
  ...
  if (!username) {
    document.querySelector(".username-wrapper").style.visibility = "visible";
  } else {
    document.querySelector(".welcome h1").textContent = `Hello, ${username}`;
    document.querySelector(".username-wrapper").style.visibility = "hidden";
  }
  ...
  submitUsername.addEventListener("click",  () => {
    ...
    if(username === ""){
      errorUserName.textContent = "Please enter a name"; 
      errorUserName.classList.add("show-error"); 
    
      setTimeout(() => {
        errorUserName.classList.remove("show-error");
      }, 3000);
    }else{
      errorUserName.classList.remove("show-error");
...
const loadTasksFromLocalStorage = () => {
  ...
  if (savedCategory) {
    selectedCategory = categories.find(category => category.title === savedCategory);
...
const categoryErrorMessage = document.querySelector("#category-error-message");
